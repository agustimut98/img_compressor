...
encoding: 
./imshrinker  c0.7 ../test-data/new425.ppm ../test-data/Cnew425ppm.ims

decoding: 

./imshrinker  d  ../test-data/Cnew425ppm.ims ../test-data/Dnew425ppm.ppm
...
The application supports raw grayscale and raw color images (ONLY FORMAT PGM or PPM) as and input file. You can convert any image to the PGM or PPM format in GIMP or with Convert of ImageMagick .
